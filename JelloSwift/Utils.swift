...
internal func +=<T, U: RangeReplaceableCollectionType where U.Generator.Element == T>(inout lhs: U, rhs: T)
{
    lhs.append(rhs)
}

internal func -=<T: Equatable, U: RangeReplaceableCollectionType where U.Generator.Element == T>(inout lhs: U, rhs: T)
{
    lhs.remove(rhs)
}
